# Functions to draw the profile of the cavity
    ...
    def CAV_coo(self):
        ...
        for k in range(len(CAV_PROF)):   
            ...
            if CAV_PROF[k] == 'TU':
                ...
                sc_prof = self.half_cell_coo(cell_data)
...
###############################################################################
    ...
    def half_cell_coo(self, cell_data):
        a = cell_data[0]
        b = cell_data[1]
        A = cell_data[2]
        B = cell_data[3]
