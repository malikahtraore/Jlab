# -*- coding: utf-8 -*-
"""
Created on Fri May 13 11:09:36 2022
...
ICui, QtBaseClass = uic.loadUiType('InnerCell.ui')

class InnerCell(QDialog, ICui):    
    def __init__(self, parent):
        super(InnerCell, self).__init__(parent)
        ...
        self.dataE=[]
        self.dataE.append(self.le_Sxeq_EC.text())
        self.dataE.append(self.le_Syeq_EC.text())
        self.dataE.append(self.le_Sxir_EC.text())
        self.dataE.append(self.le_Syir_EC.text())
        self.dataE.append(self.le_ER_EC.text())
        self.dataE.append(self.le_IR_EC.text())
        self.dataE.append(self.le_SL_EC.text())
        self.dataE.append(self.le_LEQ_IC.text())
...
##############################################################################
    ...
    def button_ok(self):
        ...
        if cont>0:
            ...
            self.le_Sxeq_IC.setText(row1[0])
            self.le_Syeq_IC.setText(row1[1])
            self.le_Sxir_IC.setText(row1[2])
            self.le_Syir_IC.setText(row1[3])
            self.le_ER_IC.setText(row1[4])
            self.le_IR_IC.setText(row1[5])
            self.le_SL_IC.setText(row1[6])
            self.le_LEQ_IC.setText(row1[8])
        self.close()
        return(row1)
