...
ICui, QtBaseClass = uic.loadUiType('InnerCell2.ui')

class InnerCell2(QDialog, ICui):    
    def __init__(self, parent):
        super(InnerCell2, self).__init__(parent)
        ...
        self.dataE=[]
        self.dataE.append(self.le_Sxeq_EC_2.text())
        self.dataE.append(self.le_Syeq_EC_2.text())
        self.dataE.append(self.le_Sxir_EC_2.text())
        self.dataE.append(self.le_Syir_EC_2.text())
        self.dataE.append(self.le_ER_EC_2.text())
        self.dataE.append(self.le_IR_EC_2.text())
        self.dataE.append(self.le_SL_EC_2.text())
...
##############################################################################
    ...
    def button_ok(self):
        ...
        if cont>0:
            ...
            self.le_Sxeq_IC_2.setText(row1[0])
            self.le_Syeq_IC_2.setText(row1[1])
            self.le_Sxir_IC_2.setText(row1[2])
            self.le_Syir_IC_2.setText(row1[3])
            self.le_ER_IC_2.setText(row1[4])
            self.le_IR_IC_2.setText(row1[5])
            self.le_SL_IC_2.setText(row1[6])
        self.close()
        return(row1)
