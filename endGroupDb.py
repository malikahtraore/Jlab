...
EGui, QtBaseClass = uic.loadUiType('EndGroup.ui')

class EndGroupDb(QDialog, EGui):    
    def __init__(self, parent, row1, row2):
        super(EndGroupDb, self).__init__(parent)
        ...
        self.le_f_2=parent.le_f_2
        self.le_beta_2=parent.le_beta
        self.le_tube_length=parent.le_tube_length
        self.le_tube_length_Rir=parent.le_tube_length_Rir
        self.lb_se_f=parent.lb_se_f
        ...
        if self.lb_se_f.text().__contains__('0') or self.lb_se_f.text().__contains__('1') or self.lb_se_f.text().__contains__('2') or self.lb_se_f.text().__contains__('3') or self.lb_se_f.text().__contains__('4') or self.lb_se_f.text().__contains__('5') or self.lb_se_f.text().__contains__('6') or self.lb_se_f.text().__contains__('7') or self.lb_se_f.text().__contains__('9') or self.lb_se_f.text().__contains__('10'):
            ...
            if ok == 1 and self.pathDB!='.':
                ...
                for i in range(len(read)):
                    ...
                    if str(line[0]).__contains__('EG'):
                        ...
                        self.TW.setItem(rowPosition , 24, QTableWidgetItem(str(line[25])))
                        self.TW.setItem(rowPosition , 25, QTableWidgetItem(str(line[26])))
                        ...
                        cell_item.setFlags(cell_item.flags() ^ Qt.ItemIsEditable)
                        cell_item=self.TW.item(rowPosition, 24)
                        cell_item.setFlags(cell_item.flags() ^ Qt.ItemIsEditable)
                        cell_item=self.TW.item(rowPosition, 25)
                        cell_item.setFlags(cell_item.flags() ^ Qt.ItemIsEditable)
    ...
    def button_ok(self):
        try:
            ...
            for i in range(len(linee)):
                if linee[i].startswith('HC') or linee[i].startswith('SC') or linee[i].startswith('B'):
                    hc.append(linee[i])
                    ...
                    if self.textEdit_EndGroup.toPlainText()!='':
                        ...
                        if cont==len(self.nameList):
                            ...
                            try:
                                ...
                                line.append(self.le_f_2.text()+';')
                                line.append(self.le_beta_2.text().replace('\n','').replace(',','')+';')
                                ...
                                line.append(self.le_Sxeq_IC.text()+';')
                                line.append(self.le_Syeq_IC.text()+';')
                                line.append(self.le_Sxir_IC.text()+';')
                                line.append(self.le_Syir_IC.text()+';')
                                line.append(self.le_ER_IC.text()+';')
                                line.append(self.le_IR_IC.text()+';')
                                line.append(self.le_SL_IC.text()+';')
                                line.append(self.le_Sxeq_EC.text()+';')
                                line.append(self.le_Syeq_EC.text()+';')
                                line.append(self.le_Sxir_EC.text()+';')
                                line.append(self.le_Syir_EC.text()+';')
                                line.append(self.le_ER_EC.text()+';')
                                line.append(self.le_IR_EC.text()+';')
                                line.append(self.le_SL_EC.text()+';')
                                line.append(self.le_LEQ_EC.text()+';')
                                line.append(self.le_LEQ_IC.text()+';')
                                line.append(self.le_tube_length.text()+';')
                                line.append(self.le_tube_length_Rir.text()+';')
                                ...
                                self.TW.setItem(rowPosition , 24, QTableWidgetItem(str(line[24]).replace(';','')))
                                self.TW.setItem(rowPosition , 25, QTableWidgetItem(str(line[25]).replace(';','')))
...
##############################################################################        
    ...
    def View(self):
        try:
            ...
            if cont>0:
                self.le_f_2.setText(row1[1])
                self.le_beta_2.setText(row1[2])
                self.le_tube_length.setText(row1[24])
                self.le_tube_length_Rir.setText(row1[25])
                self.le_Sxeq_IC.setText(row1[8])
                self.le_Syeq_IC.setText(row1[9])
                self.le_Sxir_IC.setText(row1[10])
                self.le_Syir_IC.setText(row1[11])
                self.le_ER_IC.setText(row1[12])
                self.le_IR_IC.setText(row1[13])
                self.le_SL_IC.setText(row1[14])
                self.le_Sxeq_EC.setText(row1[15])
                self.le_Syeq_EC.setText(row1[16])
                self.le_Sxir_EC.setText(row1[17])
                self.le_Syir_EC.setText(row1[18])
                self.le_ER_EC.setText(row1[19])
                self.le_IR_EC.setText(row1[20])
                self.le_SL_EC.setText(row1[21])
                self.le_LEQ_EC.setText(row1[22])
                self.le_LEQ_IC.setText(row1[23])
            self.close()
            return(row1)
        except:
